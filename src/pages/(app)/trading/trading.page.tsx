  ...
  return (
    <React.Fragment>
      ...
      <div className="flex flex-col gap-4 py-4">
        ...
        <div className="relative flex w-full items-center justify-between gap-8 overflow-clip rounded-2xl bg-[#08847B] p-8 text-white md:gap-10 md:rounded-3xl md:p-10">
          <div className="hidden h-[768px] flex-1 rounded-2xl bg-primary xl:flex"></div>

          <div className="flex w-full flex-col justify-between gap-6 lg:flex-row xl:h-[642px] xl:w-[470px] xl:flex-col">
