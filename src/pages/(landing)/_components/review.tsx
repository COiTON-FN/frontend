...
import { feedbacks, variants } from "@/utils/constants";
        ...
        <div className="mx-auto hidden gap-6 sm:gap-0 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {feedbacks.map((rv: CLIENTS_FEEDBACK, _key: number) => (
            <motion.div
              key={_key}
              className={cn(
                "mx-auto h-[400px] w-[calc(100%-10%)] cursor-pointer rounded-3xl border-2 border-[#C4C0C0] bg-background shadow-2xl shadow-black/20 transition-all duration-500 ease-in-out dark:border-border dark:bg-neutral-900 sm:mx-0 sm:h-[416.83px] sm:w-[344.38px] [&:nth-child(1)]:z-[1] [&:nth-child(1)]:translate-x-16 [&:nth-child(1)]:translate-y-0 [&:nth-child(1)]:rotate-0 lg:[&:nth-child(1)]:translate-x-[250px] lg:[&:nth-child(1)]:translate-y-12 lg:[&:nth-child(1)]:rotate-[5deg] [&:nth-child(2)]:z-[0] [&:nth-child(2)]:-translate-x-16 lg:[&:nth-child(2)]:translate-x-[100px] [&:nth-child(3)]:z-[0] [&:nth-child(3)]:translate-x-16 [&:nth-child(3)]:translate-y-8 [&:nth-child(3)]:-rotate-0 lg:[&:nth-child(3)]:-translate-x-[50px] lg:[&:nth-child(3)]:-rotate-[3deg] [&:nth-child(4)]:z-[1] [&:nth-child(4)]:-translate-x-16 [&:nth-child(4)]:translate-y-8 [&:nth-child(4)]:-rotate-0 lg:[&:nth-child(4)]:-translate-x-[250px] lg:[&:nth-child(4)]:translate-y-16 lg:[&:nth-child(4)]:-rotate-[7deg]",
                {
...
const MobileReviewCard = ({
  ...
  return (
    <motion.div
      className="flex h-[400px] w-[330px] origin-bottom items-center justify-center rounded-3xl border-2 bg-background hover:cursor-grab active:cursor-grabbing dark:bg-neutral-900 md:h-[430px] md:w-[350px]"
      style={{
        gridRow: 1,
        gridColumn: 1,
        x,
