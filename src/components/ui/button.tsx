  ...
  "inline-flex items-center justify-center whitespace-nowrap cursor-pointer rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        black:
          "bg-black dark:bg-neutral-800 dark:hover:bg-neutral-800/90 text-primary-foreground hover:bg-black/90",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input dark:border-border bg-background dark:hover:bg-neutral-900 hover:bg-accent text-muted-foreground dark:text-foreground/50 dark:hover:text-primary hover:text-primary",
        secondary:
          "bg-secondary dark:bg-background text-secondary-foreground dark:text-muted-foreground hover:bg-secondary/80",
