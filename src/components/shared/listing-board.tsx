...
const ListingBoard = ({ listingBoardValue }: {listingBoardValue: ListingBoardProps[]}) => {
  return (
    <div className="flex flex-col gap-4 rounded-t-[inherit] border-b bg-white p-4 md:p-6 lg:flex-row lg:items-center">
      ...
      <div className="flex flex-wrap items-center gap-3">
        {listingBoardValue.map(({placeholder,options}) => {
          return (
            <Select key={placeholder}>
              <SelectTrigger className="flex-1 !rounded-full bg-[#F9FAFB] lg:w-[240px]">
                <div className="flex items-center gap-3">
                  ...
                  <SelectValue placeholder={placeholder} className="line-clamp-1" />
                </div>
              </SelectTrigger>
              <SelectContent>
                <SelectGroup>
